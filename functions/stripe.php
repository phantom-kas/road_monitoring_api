...
$IineItems = [
  [
    'price_data' =>[
      'currency' => 'USD',
      'product_data' =>[
        'name' => $iData['pp']['program_title'],
      ],
        'unit_amount' => $iData['amount'] ,
    ],
      'quantity' => 1
  ]
  ];
  ...
  $paylod = $payload ??  [
    ...
    'redirectUrl' => $iData['redirectUrl'],
    'amount' => $iData['amount'],
  ];
  $token = JWT::encode($paylod, 'ACCESS_SECRETE_KEYS');
  ...
  $checkoutSession = $stripe->checkout->sessions->create([
    ...
    'mode' =>'payment',
    'success_url' => pathUrl().'pages/handel_stripe_pay_success.php?tkn='.$token.'&provider_session_id={CHECKOUT_SESSION_ID}',
    'cancel_url' =>  pathUrl().'pages/handel_stripe_pay_error.php?tkn='.$token.'&provider_session_id={CHECKOUT_SESSION_ID}',
  ]);
